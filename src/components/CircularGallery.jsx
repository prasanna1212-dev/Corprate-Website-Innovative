...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = 'bold 28px Space Grotesk, sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class Media {
  constructor({
    geometry, gl, image, index, length, renderer,
    scene, screen, text, viewport, bend,
...
class App {
  ...
  addEventListeners() {
    ...
    window.addEventListener('touchstart',  this._touchDown);
